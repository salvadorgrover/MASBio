...
resp_24 <- read_excel("Data/May 2022/may_2022_respiration_data_24hr_6_9_22.xlsx")  %>% 
  drop_na(co2_int | plot_no)##load data from IRGA
resp_48 <- read_excel("Data/May 2022/may_2022_respiration_data_48hr_6_10_22.xlsx") %>% 
  drop_na(co2_int | plot_no)
resp_72 <- read_excel("Data/May 2022/may_2022_respiration_data_72hr_6_11_22.xlsx") %>% 
  drop_na(co2_int | plot_no)

plot_treat <- read_excel("Data/May 2022/study_treatments_2022.xlsx")  ##load study_treatments_2022
soil_resp <- read_excel("Data/May 2022/fhc_and_soil_resp_2022.xlsx")   ##load fhc_and_soil_resp_2022
...
#write.csv(resp.24.clean, "respiration_clean_24h_may_2022.csv", row.names = F)
#write.csv(resp.48.clean, "respiration_clean_48h_may_2022.csv", row.names = F)
#write.csv(resp.72.clean, "respiration_clean_72h_may_2022.csv", row.names = F)
...
write.csv(offsite, "offsite_may_2022_respiration.csv", row.names = F)
