...
#write.csv(poxc_clean, "poxc_clean_august_2022.csv", row.names = F) #comment out if needed to rewrite file
...
#write.csv(offsite_clean, "offsite_poxc_august_22.csv", row.names = F) #comment out if needed to rewrite file
