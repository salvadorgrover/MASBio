...
setwd("C:/Users/salgr/Box/Data/POM & MAOM")
  ...
  pom.maom.june <- read.csv("Data/June 2021/pom_maom_2021_adj.csv") 
pom.maom.june$date <- c("June 2021")

pom.maom.aug <- read.csv("Data/August 2022/pom_maom_2022_adj.csv") %>% 
...
pom.maom.all <- smartbind(pom.maom.aug, pom.maom.june)
